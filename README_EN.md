...
# Star Field Client Full - Star Field Server Client (Full Edition)

## I. Introduction
This repository is the **full edition client** code repository for the Minecraft multiplayer server Star Field, used to maintain client-related files.
...
- Buying some fries for the authors at the dock ^_^
